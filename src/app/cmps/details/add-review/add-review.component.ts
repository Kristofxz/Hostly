...
export class AddReviewComponent {
  ...
  async onAddReview() {
    ...
    if (!user) this.snackBar.open('Kérlek jelentkezz be először!', 'Vissza', { duration: 3000 })
    else if(!review.text) this.snackBar.open('Kérlek adj hozzá leírást!', 'Vissza', { duration: 3000 })
    else {
      ...
      this.snackBar.open('Értékelés sikeresen hozzáadva!', 'Vissza', { duration: 3000 })
    }
  }
}
